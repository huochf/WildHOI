...
def visualize_hoi(args):
    ...
    hoi_recon_results = load_pickle('./outputs/{}/{}_test.pkl'.format(args.exp, object_name))
    save_dir = '__debug__/{}_{}'.format(object_name, args.exp)
    ...
    for item in tqdm(hoi_recon_results):
        ...
        image_dir = os.path.join(args.root_dir, object_name, 'images_temp', video_id)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_dir', type=str, default='/storage/data/huochf/HOIYouTube', help="The dataset directory")
    parser.add_argument('--object', type=str, default='barbell')
    parser.add_argument('--exp', type=str, default='optim_with_kps_flow')
